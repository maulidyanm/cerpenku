...
class Comedy : AppCompatActivity(), AdapterKarya.OnFavoriteClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview = findViewById(R.id.recyclercomedy)
        searchView = findViewById(R.id.seacrhcomedy)
        ...
        progressBar = findViewById(R.id.progressBarComedy)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                        ...
                        if (karya != null) {
                            ...
                            komentarRef.addListenerForSingleValueEvent(object : ValueEventListener {
                                ...
                                override fun onCancelled(error: DatabaseError) {
                                    Toast.makeText(this@Comedy, error.message, Toast.LENGTH_SHORT).show()
                                }
                            })
                            karyaList.add(karya)
                        }
                    ...
                    if (karyaList.isNotEmpty()) {
                        ...
                        findViewById<TextView>(R.id.datakosongkomedi).visibility = View.GONE
                    } else {
                        // Jika tidak ada data, tampilkan pesan "Data Kosong"
                        recyclerview.visibility = View.GONE
                        findViewById<TextView>(R.id.datakosongkomedi).visibility = View.VISIBLE
                    }
                } else {
