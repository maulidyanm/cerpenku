...
class Pendidikan : AppCompatActivity(), AdapterKarya.OnFavoriteClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview = findViewById(R.id.recyclerpendidikan)
        searchView = findViewById(R.id.searchpendidikan)
        ...
        progressBar = findViewById(R.id.progressbarpendidikan)
    ...
    private fun getData() {
        ...
        val persahabatanQuery = myRef.orderByChild("kategori").equalTo("Pendidikan")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                        ...
                        if (karya != null) {
                            ...
                            komentarRef.addListenerForSingleValueEvent(object : ValueEventListener {
                                ...
                                override fun onCancelled(error: DatabaseError) {
                                    Toast.makeText(this@Pendidikan, error.message, Toast.LENGTH_SHORT).show()
                                }
                            })
                            karyaList.add(karya)
                        }
                    ...
                    if (karyaList.isNotEmpty()) {
                        ...
                        findViewById<TextView>(R.id.datakosongpendidikan).visibility = View.GONE
                    } else {
                        // Jika tidak ada data, tampilkan pesan "Data Kosong"
                        recyclerview.visibility = View.GONE
                        findViewById<TextView>(R.id.datakosongpendidikan).visibility = View.VISIBLE
                    }
                } else {
