...
class Teknologi : AppCompatActivity(), AdapterKarya.OnFavoriteClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview = findViewById(R.id.recyclerteknologi)
        searchView = findViewById(R.id.searchteknologi)
        ...
        progressBar = findViewById(R.id.progressbarteknologi)
    ...
    private fun getData() {
        ...
        val persahabatanQuery = myRef.orderByChild("kategori").equalTo("Komedi")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                        ...
                        if (karya != null) {
                            ...
                            komentarRef.addListenerForSingleValueEvent(object : ValueEventListener {
                                ...
                                override fun onCancelled(error: DatabaseError) {
                                    Toast.makeText(this@Teknologi, error.message, Toast.LENGTH_SHORT).show()
                                }
                            })
                            karyaList.add(karya)
                        }
                    ...
                    if (karyaList.isNotEmpty()) {
                        ...
                        findViewById<TextView>(R.id.datakosongteknologi).visibility = View.GONE
                    } else {
                        // Jika tidak ada data, tampilkan pesan "Data Kosong"
                        recyclerview.visibility = View.GONE
                        findViewById<TextView>(R.id.datakosongteknologi).visibility = View.VISIBLE
                    }
                } else {
